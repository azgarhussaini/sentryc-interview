...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARKETPLACE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MARKETPLACE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MARKETPLACE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_MARKETPLACE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_MARKETPLACE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_MARKETPLACE actions', async () => {
      const arg = 42666;
