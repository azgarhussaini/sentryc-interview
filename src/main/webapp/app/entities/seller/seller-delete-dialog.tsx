...
export const SellerDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/seller' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sentryInterviewApp.seller.delete.question">
        <Translate contentKey="sentryInterviewApp.seller.delete.question" interpolate={{ id: sellerEntity.id }}>
