...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SELLER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SELLER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SELLER actions', async () => {
    ...
    it('dispatches UPDATE_SELLER actions', async () => {
      const arg = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
    ...
    it('dispatches PARTIAL_UPDATE_SELLER actions', async () => {
    ...
    it('dispatches DELETE_SELLER actions', async () => {
      const arg = 42666;
